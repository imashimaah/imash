        ...
        if (config.WORKTYPE == 'public') {
            ...
            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                ...
                if (config.FULLEVA == 'true') {
                    ...
                    await conn.sendMessage(conn.user.jid, '\n*𓄂𐌠̌̌̌̌̌̌̌̌̌̌𐅕̴̬̬̬̬̬̬̬̬̬̬𐤠ꓢ̌̌̌̌̌̌̌̌̌̌𐅒̬̬̬̬̬̬̬̬̬̬𓀞 Working as Public!😎*\n', MessageType.text);
                }               
                await git.fetch();
                var commits = await git.log([config.BRANCH + '..origin/' + config.BRANCH]);
                if (commits.total === 0) {
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [𓄂𐌠̌̌̌̌̌̌̌̌̌̌𐅕̴̬̬̬̬̬̬̬̬̬̬𐤠ꓢ̌̌̌̌̌̌̌̌̌̌𐅒̬̬̬̬̬̬̬̬̬̬𓀞] --*' + 
                                    '\n*𓄂𐌠̌̌̌̌̌̌̌̌̌̌𐅕̴̬̬̬̬̬̬̬̬̬̬𐤠ꓢ̌̌̌̌̌̌̌̌̌̌𐅒̬̬̬̬̬̬̬̬̬̬𓀞 an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [𓄂𐌠̌̌̌̌̌̌̌̌̌̌𐅕̴̬̬̬̬̬̬̬̬̬̬𐤠ꓢ̌̌̌̌̌̌̌̌̌̌𐅒̬̬̬̬̬̬̬̬̬̬𓀞] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
