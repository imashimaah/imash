...
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/Mention.mp3'), MessageType.audio, { mimetype: uploads/YTMP3.RED - polozhenie (zedline remix) zedline.mp3, quoted : message.data, ptt: true})
        }
...
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: uploads/YTMP3.RED - polozhenie (zedline remix) zedline.mp3, quoted: message.data, ptt: true})
}
});
    }
